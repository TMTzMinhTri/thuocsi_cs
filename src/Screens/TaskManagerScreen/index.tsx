                            ...
                            <table className="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> Herman Beck </td>
                                        <td>
                                            <Progress variant="success" now={25} />
                                        </td>
                                        <td> $ 77.99 </td>
                                        <td> May 15, 2015 </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> Messsy Adam </td>
                                        <td>
                                            <Progress variant="danger" now={75} />
                                        </td>
                                        <td> $245.30 </td>
                                        <td> July 1, 2015 </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> John Richards </td>
                                        <td>
                                            <Progress variant="warning" now={90} />
                                        </td>
                                        <td> $138.00 </td>
                                        <td> Apr 12, 2015 </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> Peter Meggik </td>
                                        <td>
                                            <Progress variant="primary" now={50} />
                                        </td>
                                        <td> $ 77.99 </td>
                                        <td> May 15, 2015 </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> Edward </td>
                                        <td>
                                            <Progress variant="danger" now={60} />
                                        </td>
                                        <td> $ 160.25 </td>
                                        <td> May 03, 2015 </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td> Henry Tom </td>
                                        <td>
                                            <Progress variant="warning" now={20} />
                                        </td>
                                        <td> $ 150.00 </td>
                                        <td> June 16, 2015 </td>
                                    </tr>
                            ...
                            <table className="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> Edward </td>
                                        <td>
                                            <Progress variant="danger" now={35} />
                                        </td>
                                        <td> $ 160.25 </td>
                                        <td> May 03, 2015 </td>
                                    </tr>
