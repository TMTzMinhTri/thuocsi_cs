...
import { incrementWithDelay } from 'Store/actions/layout.actions';
...
const LoginScreen: React.FC<Iprops> = ({ isAuthenticated, onIncrement }) => {
    ...
    return <div className="d-flex align-items-center auth px-0">
